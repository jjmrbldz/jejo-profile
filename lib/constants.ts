...
export const featuredProjects = [
  {
    ...
    srcSet: [
      ...
      "/videos/splendoor/3Request Care Plan.mp4", 
      "/videos/splendoor/4Invoicing.mp4", 
      "/videos/splendoor/5ManualPayment.mp4", 
      "/videos/splendoor/6CardWalletPayment.mp4", 
    ],
    techStack: ["Expo Go", "NativeWind", "ReactJS",  "Mantine", "TypeScript", "NodeJS",  "Fastify", "Drizzle ORM", "MySQL"],
    link: "https://github.com/jjmrbldz/splendoor-app",
  },
  {
    title: "Tazza 365",
